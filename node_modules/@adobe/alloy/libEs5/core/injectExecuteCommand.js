...
var _default = ({
        ...
        executor = () => {
          return configurePromise.then(componentRegistry => {
            ...
            if (!command || !(0, _index.isFunction)(command.run)) {
              const commandNames = [_coreCommands.CONFIGURE, _coreCommands.SET_DEBUG].concat(componentRegistry.getCommandNames()).join(", ");
  ...
  return (commandName, options = {}) => {
    return new Promise(resolve => {
      ...
      const result = (0, _index.isObject)(rawResult) ? rawResult : {};
